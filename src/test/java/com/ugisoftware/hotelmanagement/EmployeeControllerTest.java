...
public class EmployeeControllerTest {
	...
	Employee testEmployee= new Employee(2L,"Test-Name-2","Test-Surname-2","Test-Job-2","01-01-1999",Gender.Erkek,"01-01-2020","01-01-2021","Test-Adress-2","184-456-7744","testsame@test.com",Blood.ABRhN,2000);
    ...
    public void givenInvalidEmployeeId_whenGetEmployeeById_thenReturnEmpty() throws Exception{
        ...
        given(employeeService.getEmployee(employeeId)).willReturn(null);
